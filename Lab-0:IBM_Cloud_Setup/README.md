...
<img width="1000" alt="Banner" src="/images/img002.png"> 

## Step-4: Create API Key 

1. Go to - "Manage" > "Access (IAM)"

<img width="1000" alt="Banner" src="/images/img003.png"> 

2. Click on - "API keys" > "Create"

<img width="1000" alt="Banner" src="/images/img004.png"> 

3. Give a "Name" and "Description" to the API key and click on "Create"

<img width="1000" alt="Banner" src="/images/img005.png"> 

4. API key is successfully created. *** You can copy it or download it. ***

<img width="1000" alt="Banner" src="/images/img006.png"> 
